...
$asistencia = AsistenciaAdo::ReporteListaAsistenciaEmpleadosFechas($_GET["fechaInicial"], $_GET["fechaFinal"]);
    ...
    <tr>
        <td width="100%" style="border: 0mm solid #888888;text-align: center;vertical-align: middle;">
            <span style="font-size: 14pt; color: black; font-family: sans;">
                <b>RESUMEN DE ASISTENCIAS DEL PERSONAL</b>
            </span>
            <br>
...
';
    ...
    $mpdf->SetTitle("Resumen de Asistencia - Personal");
