...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        <div class="tile mb-4">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="form-text">Nombre de la empresa: <i
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <input id="terminos" type="text" class="form-control"
                            placeholder="Ingrese la descripción de los términos">
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    $(document).ready(function() {
        ...
        $("#btnGuardar").click(function() {
            if ($("#representante").val() == '' || $("#representante").val().length < 7) {
                ...
                tools.ModalDialog('Empresa', '¿ Desea guardar los datos', 'info', function(result){
                    if(result){
                        registrarCliente($("#representante").val(), $("#empresa").val(), $("#ruc").val(), $("#telefono").val(),
    ...
    function registrarCliente(representante, empresa, ruc, telefono, celular, email, web, direccion, terminos) {
