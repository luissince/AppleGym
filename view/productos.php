            ...
            <script>
                                ...
                                if (data.productos.length == 0) {
                                    ...
                                    for (let producto of data.productos) {
                                        ...
                                        tbLista.append('<tr role="row" class="odd">' +
                                            ...
                                            '<td class="text-right">' + (tools.formatMoney(producto.precio) + " " + producto.impuesto) + '</td>' +
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.estado == 1) {
                                ...
                                for (let impuesto of result.impuestos) {
                ...
                function crudProducto() {
                    if ($("#txtClave").val().trim() == '') {
                        ...
                        tools.AlertWarning("Producto: ", "Seleccione el impuesto del producto.");
                        $("#cbImpuesto").focus();
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.estado == 1) {
                                ...
                                $("#cbImpuesto").val(result.producto.idImpuesto)
                                $("#txtCosto").val(result.producto.costo)
                                $("#txtStockMinimo").val(result.producto.stockMinimo)
                                $("#txtStockMaximo").val(result.producto.stockMaximo)
