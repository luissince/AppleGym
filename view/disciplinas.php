                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="descripción" type="text" name="descripción" class="form-control"
                                                    placeholder="Ingrese la descripción" required="" minlength="8">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-hover table-bordered dataTable no-footer"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting_asc" aria-controls="sampleTable" rowspan="1"
                                                            colspan="1" style="width: 107px;">Nombre</th>
                                                        <th class="sorting" aria-controls="sampleTable" rowspan="1"
                                                            colspan="1" style="width: 75px;">Color
                                                        </th>
                                                        <th class="sorting" aria-controls="sampleTable" rowspan="1"
                                                            colspan="1" style="width: 250px;">Descripción</th>    
                                                        <th class="sorting" aria-controls="sampleTable" rowspan="1"
                                                ...
                                                <tbody id="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Yoga</td>
                                                        <td>
                                                            <input id="colorcito" type="color" value="#ffffff" onchange="console.log($('#colorcito').val())"/>
                                                        </td>
                                                        <td>Descripción del color</td>
                                                        <td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-5">
                                            <div class="dataTables_info" id="sampleTable_info" role="status"
                                                aria-live="polite">Mostrando de 1 a 10 Disciplina(s) de (2)</div>
                                        </div>
