...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <h1><i class="fa fa-arrow-circle-down"></i> Ingresos</h1>
        </div>
                                    ...
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill"
                                                href="#pills-home" role="tab" aria-selected="true">Básico</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill"
                                                href="#pills-profile" role="tab" aria-selected="false">Disciplinas</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="meses">Duración(Meses): <i
                                                                class="fa fa-fw fa-asterisk text-danger"></i></label>
                                                        <input id="meses" type="number" name="meses"
                                                            class="form-control"
                                                            placeholder="Ingrese la número de meses" required=""
                                                            minlength="8">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="dias" type="number" name="dias" class="form-control"
                                                            placeholder="Ingrese la número de dias" required=""
                                                            minlength="8">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="freeze" type="number" name="freeze"
                                                            class="form-control" placeholder="Ingrese los dias libres"
                                                            required="" minlength="8">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="activo"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="prueba"
                                                                    type="checkbox">Prueba
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="basico" type="radio"
                                                                    name="tipodisciplina" checked>Iliminato
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" id="disciplina"
                                                                    type="radio" name="tipodisciplina">Sujeto por
                                                                Disciplina
                                                            </label>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting" aria-controls="sampleTable"
                                                                    rowspan="1" colspan="1" style="width: 20px;">Nombre
                                                                </th>
                                                                ...
                                                                <th class="sorting" aria-controls="sampleTable"
                                                                    rowspan="1" colspan="1" style="width: 75px;">Opción
                                                                </th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number" class="form-control"
                                                                        placeholder="Ingrese el # de sesiones">
                                                                </td>
                                                                <td>
            ...
            success: function(result) {
                if (result.estado == 1) {
                    ...
                    for (let plan of result.planes) {
                        let tiempo = plan.meses == 1 ? plan.meses + " Mes y " + (plan.dias == 1 ? plan
                            .dias + " día" : plan.dias + " dias") : plan.meses + " Meses y " + (plan
                            .dias == 1 ? plan.dias + " día" : plan.dias + " dias");
                        let freeze = plan.freeze == 1 ? plan.freeze + " día" : plan.freeze + " dias";
                        let estado = plan.estado == 1 ?
                        ...
                        tbLista.append('<tr>' +
                            ...
                            '               <td>' +
                            '                   <button class="btn btn-warning btn-sm" onclick="updateplan(\'' +
                            plan.idPlan + '\')"><i class="fa fa-wrench"></i> Editar</button>' +
                            '               </td>' +
                            '               <td>' +
                            '                   <button class="btn btn-danger btn-sm" onclick="deleteplan(\'' +
                            plan.idPlan + '\')"><i class="fa fa-trash"></i> Eliminar</button>' +
                            '               </td>' +
                            '           </tr>');
                    }
