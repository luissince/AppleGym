...
<aside class="app-sidebar">
        <div class="app-sidebar__user">
                <img class="app-sidebar__user-avatar" src="./images/usuario.png" width="60" alt="User Image">
                <div>
                        <p class="app-sidebar__user-name"><?= $_SESSION["Nombres"] ?></p>
                        <p class="app-sidebar__user-name"><?= $_SESSION["Apellidos"] ?></p>
        ...
        <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="disciplinas.php"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Disciplinas</span></a></li>
