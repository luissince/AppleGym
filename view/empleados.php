...
?>
        ...
        <body class="app sidebar-mini">
            ...
            <main class="app-content">
                ...
                <div class="app-title">
                    <h1><i class="fa fa-address-book-o"></i> Empleados</h1>
                </div>
                                    ...
                                    <div class="tile p-0">
                                        ...
                                        <div class="tile-body">
                                            <ul class="nav nav-tabs mb-2" role="tablist">
                                                <li class="nav-item">
                                                    <a id="navBasico" class="nav-link active" href="#basico" role="tab" data-toggle="tab">Básicos</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a id="navContanto" class="nav-link" href="#contacto" role="tab" data-toggle="tab">Contacto</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a id="navLabores" class="nav-link" href="#labores" role="tab" data-toggle="tab">Laborales</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a id="navAcceso" class="nav-link" href="#acceso" role="tab" data-toggle="tab">Acceso</a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="labores">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
            ...
            <script>
                ...
                let editView = "<?php echo $_SESSION["Roles"][8]["actualizar"]; ?>";
                let deleteView = "<?php echo $_SESSION["Roles"][8]["eliminar"]; ?>";
                                ...
                                if (result.empleados.length == 0) {
                                    ...
                                    for (let empleado of result.empleados) {
                                        ...
                                        let btnUpdate = editView == 1 ?
                                            '<button class="btn btn-warning" onclick="updateEmpleado(\'' + empleado.idEmpleado + '\')">' +
                                            '<i class="fa fa-pencil"></i>' +
                                            '</button>' : '-';
                                        let btnDelete = deleteView == 1 ?
                                            '<button class="btn btn-danger" onclick="deleteEmpleado(\'' + empleado.idEmpleado + '\')">' +
                            ...
                            if (result) {
                                $.ajax({
                                    ...
                                    data: JSON.stringify({
                                        ...
                                        "formaPago": $("#pago").val(),
                                        "entidadBancaria": $("#banco").val().trim(),
