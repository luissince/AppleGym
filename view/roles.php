                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="nombre" type="text" name="nombre" class="form-control" placeholder="Ingrese el nombre" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="descripcion" type="text" name="descripcion" class="form-control" placeholder="Ingrese la descripción" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="claveAlterna" type="text" name="claveAlterna" class="form-control" placeholder="Ingrese la clave alterna" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 30px;">#</th>
                                                <th class="sorting_asc" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 180px;">Modulo</th>
                                                <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 30px;">Mostrar</th>
                                                <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 30px;">Insertar</th>
                                                <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 30px;">Actualizar</th>
                                                <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 30px;">Eliminar</th>
                                                <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 30px;">Reporte</th>
                                ...
                                <table class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 250px;">Descripcion</th>
                                            <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 72px;">Clave alterna</th>
                                            <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 72px;">Estado</th>
                                            <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 69px;">Sistema</th>
                                            <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 59px;">Acceso</th>
                                            <th class="sorting" aria-controls="sampleTable" rowspan="1" colspan="1" style="width: 59px;">Actualizar</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbLista">
                                    </tbody>
